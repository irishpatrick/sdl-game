...
int TextboxS::currentLine = -1;
Canvas TextboxS::window;
std::vector<Text*> TextboxS::lines;
int TextboxS::x = 0;
int TextboxS::y = 0;
bool TextboxS::visible = false;
...
void TextboxS::fillDialogue(const std::string& str)
{
    Text* t = new Text();
    lines.push_back(t);
